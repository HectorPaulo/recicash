...
const Empresas = () => {
  ...
  const handleEditSubmit = async (e) => {
    e.preventDefault();
    console.log(editModal.empresa.id);
        ...
        <div className="flex flex-col items-center min-w-2/3 justify-start min-h-screen">
                ...
                {empresas.map((empresa) => (
                  <tr
                    ...
                    className={`text-center ${
                      selected?.id === empresa.id ? "bg-green-100" : ""
                    }`}
                    onClick={() => setSelected(empresa)}
                  >
                    <td className="py-2 px-4 text-white font-semibold">{empresa.empresa || "-"}</td>
                    <td className="py-2 px-4 text-white font-semibold">{empresa.ubicacion || "-"}</td>
          ...
          {detailModal.show && (
            <Modal onClose={() => setDetailModal(initialModalState)}>
              ...
              <p className="my-5">
                <b className="text-xl text-green-800 font-black">Empresa:</b>{" "}
                {detailModal.empresa.empresa}
              </p>
              <p className="my-5">
                <b className="text-xl text-green-800 font-black">Ubicación:</b>{" "}
              ...
              <p className="my-5">
                <b className="text-xl text-green-800 font-black">Cupones:</b>{" "}
          ...
          <div>
            <Link
              ...
              className="bg-green-800 hover:scale-105 hover:animate-pulse hover:bg-green-950 cursor-pointer mt-4 px-4 py-2 rounded font-black text-white flex items-center gap-2"
            >
              Agregar empresa
