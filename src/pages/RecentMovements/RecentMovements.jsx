        ...
        <div className="flex-1">
          <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <table className="min-w-full text-left">
                ...
                <tbody className="text-gray-800">
                  {[
                    ...
                    { id: '#5045', date: '27 Mar, 2021', total: '$25.00 (1 Product)', status: 'Processing' },
                    ...
                    <tr key={index} className="border-b hover:bg-green-50">
                      ...
                      <td className={`py-3 ${item.status === 'Completed' ? 'text-green-600' : 'text-yellow-600'}`}>
                        {item.status}
                      </td>
                      <td className="py-3">
            ...
            <div className="flex justify-center items-center gap-2 mt-6">
              ...
              <button className="px-3 py-1 rounded bg-gray-200 text-gray-600 hover:bg-gray-300">3</button>
              <button className="px-3 py-1 rounded bg-gray-200 text-gray-600 hover:bg-gray-300">›</button>
            </div>
          </div>
