        ...
        <div className="w-64 bg-white rounded-lg shadow-md p-6 h-fit">
          ...
          <ul className="space-y-4 text-gray-700">
            ...
            <li className="flex items-center gap-2 text-gray-500">
              ...
              <Link to="/RecentMovements" className="hover:text-green-600">Recent movements</Link>
            </li>
            <li className="flex items-center gap-2 text-gray-500">
              <span className="w-2 h-2 rounded-full bg-gray-300 inline-block"></span>
              Settings
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex-1">
              ...
              <p className="text-gray-600">4140 Parker Rd. Allentown, New Mexico</p>
              ...
              <button className="text-green-600 hover:underline text-sm">Edit Address</button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link to="/recent-movements" className="text-green-600 hover:underline text-sm">
                View All
              </Link>
            </div>
            <table className="min-w-full text-left text-sm">
              ...
              <tbody className="text-gray-800">
                {[
                  ...
                  { id: '#703', date: '24 May, 2020', total: '$25.00 (1 Product)', status: 'Processing' },
