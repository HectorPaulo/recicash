  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 mt-20 p-4 flex flex-col items-center">
        <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8  p-8 rounded-xl">
          <div>
            <h1 className="text-8xl font-bold mb-4 text-center lg:text-left text-white">
              Bienvenido a <strong className="text-green-300">Recicash</strong>
            </h1>
            <p className="text-xl font-bold mb-8 text-center lg:text-left text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {cards.map((card, index) => (
                <div
                  key={index}
                  className="bg-white/70 backdrop-blur-sm rounded-xl p-6 border-2 border-white/20 hover:bg-white/80 transition-all duration-300"
                >
