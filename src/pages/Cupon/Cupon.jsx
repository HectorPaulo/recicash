/* eslint-disable no-unused-vars */
  ...
  const Cupon = () => {
    ...
    const fetchCupones = async () => {
      try {
        console.log("Obteniendo cupones para empresaId:", empresaId);
        const res = await axios.get(
          `${import.meta.env.VITE_API_URL}/cupon/empresa/${empresaId}`
        );
        console.log("Cupones recibidos:", res.data);
    ...
    const handleCreate = async (e) => {
      ...
      try {
        const res = await axios.post(`${import.meta.env.VITE_API_URL}/cupon`, {
          ...form,
          empresa: empresaId,
        });
        console.log("Respuesta al crear cupón:", res.data);
