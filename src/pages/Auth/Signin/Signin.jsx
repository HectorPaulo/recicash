            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-4xl px-4">
                ...
                >
                    <form onSubmit={handleSignin} className="mx-auto flex items-center space-y-4 py-12 px-8 font-semibold text-gray-800 flex-col">
                        ...
                        <button
                            className={`w-2/3 p-2 rounded-xl font-black text-gray-900 hover:text-gray-300 cursor-pointer hover:bg-gradient-to-r hover:from-green-700 hover:to-green-800 bg-gray-300 border-none hover:border-blue-500 transition-all duration-200 ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
                            type="submit"
                            disabled={isLoading}
                        >
                            {isLoading ? (
