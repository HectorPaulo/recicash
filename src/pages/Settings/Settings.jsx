          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 p-6">
            ...
            <div className="lg:col-span-3">
                      ...
                      <div className="bg-white/30 backdrop-blur-sm rounded-lg shadow mb-6">
                        ...
                        <h2 className="text-green-100 text-center text-6xl font-black">Preferencias de la cuenta</h2>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                          ...
                          <div className="space-y-6">
                            <div>
                            <label className="block text-gray-800 text-lg font-semibold mb-2">Nombre</label>
                            <input 
                              type="text" 
                            ...
                            <div>
                            <label className="block text-gray-800 text-lg font-semibold mb-2">Apellido</label>
                            <input 
                              type="text" 
                              className="w-1/2 h-12 bg-white/50 rounded-xl outline outline-offset-[-1px] outline-neutral-200 px-4 text-gray-950"
                            ...
                            <div>
                            <label className="block text-gray-800 text-lg font-semibold mb-2">Correo Electrónico</label>
                            <input 
                              type="email" 
                            ...
                            <div>
                            <label className="block text-gray-800 text-lg font-semibold mb-2">Número de Teléfono</label>
                            <input 
                              type="text" 
                              className="w-full h-12 bg-white/50 rounded-xl outline outline-offset-[-1px] outline-neutral-200 px-4 text-gray-950"
              ...
              {activeTab === 'account' && (
                      <div className="bg-white/30 backdrop-blur-sm rounded-lg shadow mb-6">
                        <div className="px-6 py-4">
                        <h2 className="text-green-100 text-center text-6xl font-black">Información avanzada</h2>
                        </div>
                        
                        <div className="p-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                          <div>
                          <label className="block text-gray-800 text-lg font-semibold mb-2">Apellido paterno</label>
                          <input 
                            type="text" 
                            className="w-full h-12 bg-white/50 rounded-xl outline outline-offset-[-1px] outline-neutral-200 px-4 text-gray-950"
                            defaultValue="Santiago"
                          ...
                          <div>
                          <label className="block text-gray-800 text-lg font-semibold mb-2">Apellido materno</label>
                          <input 
                            type="text" 
                            className="w-full h-12 bg-white/50 rounded-xl outline outline-offset-[-1px] outline-neutral-200 px-4 text-gray-950"
                            defaultValue="García"
                          ...
                          <label className="block text-gray-800 text-lg font-semibold mb-2">Dirección</label>
                          <input 
                            type="text" 
                            className="w-full h-12 bg-white/50 rounded-xl outline outline-offset-[-1px] outline-neutral-200 px-4 text-gray-950"
                          ...
                          <div>
                          <label className="block text-gray-800 text-lg font-semibold mb-2">Estado</label>
                          <div className="w-full h-12 bg-white/50 rounded-xl outline outline-offset-[-1px] outline-neutral-200 px-4 flex items-center justify-between">
                            <span className="text-gray-950">Oaxaca de Juárez, Oaxaca</span>
                            <span className="w-4 h-4 transform rotate-180">▴</span>
                          </div>
                          </div>
                          
                          <div>
                          <label className="block text-gray-800 text-lg font-semibold mb-2">Códico postal</label>
                          <input 
                            type="text" 
                            className="w-full h-12 bg-white/50 rounded-xl outline outline-offset-[-1px] outline-neutral-200 px-4 text-gray-950"
                            defaultValue="20033"
                      ...
                      <div className="bg-white/30 backdrop-blur-sm rounded-lg shadow">
                        <div className="px-6 py-4">
                        <h2 className="text-green-100 text-center text-6xl font-black">Cambiar contraseña</h2>
                        </div>
                        
                        <div className="p-6">
                        <div className="space-y-6">
                          <div>
                          <label className="block text-gray-800 text-lg font-semibold mb-2">Contraseña actual</label>
                          ...
                          <div>
                            <label className="block text-gray-800 text-lg font-semibold mb-2">Nueva contraseña</label>
                            <div className="w-full bg-white/50 rounded-xl outline outline-offset-[-1px] outline-neutral-200 flex items-center">
                            <input 
                              type="password" 
                              className="flex-grow h-12 px-4 text-gray-950 bg-transparent outline-none"
                          ...
                          <div>
                            <label className="block text-gray-800 text-lg font-semibold mb-2">Confirmar contraseña</label>
                            <div className="w-full bg-white/50 rounded-xl outline outline-offset-[-1px] outline-neutral-200 flex items-center">
                            <input 
                              type="password" 
                              className="flex-grow h-12 px-4 text-gray-950 bg-transparent outline-none"
